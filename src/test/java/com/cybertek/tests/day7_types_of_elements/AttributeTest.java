...
public class AttributeTest {
    ...
    public void test1(){
        ...
        //get the value of typr attribute
        System.out.println(blueRadioBtn.getAttribute("type"));
        //get value of name attribtue
        ...
        //tring to get Att. that doesnt exist
        //when we use non exist att. it will return null to us
       ...
       String outerHTML=button2.getAttribute("outerHTML");
        ...
        System.out.println(button2.getAttribute("innerHTML"));// html de ki texi verir.
        driver.quit();
    }
