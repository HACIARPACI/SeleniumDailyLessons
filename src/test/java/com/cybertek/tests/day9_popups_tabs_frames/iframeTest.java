...
public class iframeTest {
  ...
  /*  @AfterMethod
    ...
    public void test1() throws InterruptedException {
        ...
        //2. switching with index  first frame
        ...
        // second way switching back to parent   default content en tepeye gider  bu bir üst parentFrame 'e
...
·       We can only switch from parent to child, or from child to parent.
    ...
    public void test2(){
        ...
        //top ındex0 bottom index1  defaılt a cıkınca iki index kalıyor
